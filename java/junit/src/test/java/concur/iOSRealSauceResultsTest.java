...
public class iOSRealSauceResultsTest implements SauceOnDemandSessionIdProvider {
    ...
    public iOSRealSauceResultsTest(String os, String version, String device) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("build", "build_1000");
